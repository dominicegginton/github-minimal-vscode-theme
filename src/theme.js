...
function theme ({ name, style }) {
  ...
  return {
    ...
    colors: {
      ...
      'gitDecoration.addedResourceForeground': pick({ light: colors.green[5], dark: colors.green[6] }),
      'gitDecoration.modifiedResourceForeground': pick({ light: colors.blue[5], dark: colors.blue[6] }),
      'gitDecoration.deletedResourceForeground': pick({ light: colors.red[5], dark: colors.red[6] }),
      'gitDecoration.stageModifiedResourceForeground': pick({ light: colors.blue[5], dark: colors.blue[6] }),
      'gitDecoration.stageDeletedResourceForeground': pick({ light: colors.red[5], dark: colors.red[6] }),
      'gitDecoration.untrackedResourceForeground': pick({ light: colors.green[5], dark: colors.green[6] }),
